...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-1.5 rounded-lg border border-input bg-background px-4 py-2 text-sm whitespace-nowrap shadow-sm",
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            "duration-[var(--duration-fast)] ease-[var(--ease-luxury)]",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.GroupLabel
      ...
      className={cn("px-2 py-1.5 text-xs text-muted-foreground font-semibold", className)}
      {...props}
    />
  )
}
